...
void PROXY_SETTINGS::ApplyRawSettings() {
    ...
    pipeReadBufLocalProxy = 8388608*10;//-1;//8000000; //FindInt("PIPE_READ_BUFFER_LOCAL_PROXY");
    pipeWriteBufLocalProxy = 8388608*10;//-1;//4194304; //FindInt("PIPE_WRITE_BUFFER_LOCAL_PROXY");
    pipeTransferUnit = 2147483647; //FindInt("PIPE_TRANSFER_UNIT");
    tcpTransferUnit = 2147483647; //FindInt("TCP_TRANSFER_UNIT");
    pipeBufDataCapacity = 4000000*10; //FindInt("PIPE_BUFFER_DATA_CAPACITY");
    pipeBufMsgCapacity = 8192*10; //FindInt("PIPE_BUFFER_MSG_CAPACITY");
    pipePerConnBufDataCapacity = 2000000*10; //FindInt("PIPE_PER_CONN_BUFFER_DATA_CAPACITY");
    tcpOverallBufMsgCapacity = 32768*10; //FindInt("TCP_OVERALL_BUFFER_MSG_CAPACITY");
    tcpOverallBufDataCapacity = 33554432*10; //FindInt("TCP_OVERALL_BUFFER_DATA_CAPACITY");
    tcpPerConnBufDataCapacity = 20000000*10; //FindInt("TCP_PER_CONN_BUFFER_DATA_CAPACITY");
