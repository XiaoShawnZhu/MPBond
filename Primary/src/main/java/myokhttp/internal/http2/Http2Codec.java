...
import myokhttp.internal.http.RealResponseBody;
import myokhttp.internal.http.RequestLine;
import myokhttp.internal.http.StatusLine;
import okio.Buffer;
...
import static myokhttp.internal.http.StatusLine.HTTP_CONTINUE;
import static myokhttp.internal.http2.Header.RESPONSE_STATUS;
import static myokhttp.internal.http2.Header.TARGET_AUTHORITY;
import static myokhttp.internal.http2.Header.TARGET_METHOD;
import static myokhttp.internal.http2.Header.TARGET_PATH;
import static myokhttp.internal.http2.Header.TARGET_SCHEME;
...
public final class Http2Codec implements HttpCodec {
  ...
  @Override public void cancel() {
    Log.d("Http2Codec", "Cancel called @ "+System.currentTimeMillis());
