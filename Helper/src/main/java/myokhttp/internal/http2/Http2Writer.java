...
import static myokhttp.internal.http2.Http2.FLAG_NONE;
...
import static myokhttp.internal.http2.Http2.illegalArgument;
...
final class Http2Writer implements Closeable {
  ...
  public synchronized void windowUpdate(int streamId, long windowSizeIncrement) throws IOException {
    ...
    Log.d("Http2Writer", "  ---> WINDOW_UPDATE for "+streamId+" : "+windowSizeIncrement);
    int length = 4;
